...
def process_posts(raw_file_path, processed_file_path="data/processed_file_path.json"):
    enriched_posts = [ ]
    ...
    with open(processed_file_path, encoding='utf-8', mode="w") as outflie:
        json.dump(enriched_posts, outflie, indent=4)
